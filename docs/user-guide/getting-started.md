...
reduce background noise, or lower the input level if clipping appears.

Use Lock & Ring to compare changes between takes. Do not chase every frame or
percentage. Room sound, microphone placement, vowel shape, and singer balance
all affect the readings.
